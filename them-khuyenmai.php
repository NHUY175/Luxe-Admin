          ...
          $row = mysqli_fetch_assoc($result);
            ...
            <form action= "ds-khuyenmai.php?opt=update_cp" class="edit-coupon" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="date" name="date" id="thoigianbatdau" name="thoigianbatdau" class="form-input" value="<?php echo $row["luot_su_dung"]; ?>"/>
              </div>
              <div class="form-group">
                <label for="thoigianketthuc" class="form-label">Thời gian kết thúc</label>
                <input type="date" name="date" id="thoigianketthuc" name="thoigianketthuc" class="form-input" value="<?php echo $row["luot_su_dung"]; ?>"/>
              </div>
